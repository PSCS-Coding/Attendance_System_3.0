...
<body>
	...
	<script>
		$(document).ready(function () {
			...
			$('.links').html(
				'<li class="nav-item"><a href="#" class="nav-link">Groups</a></li><li class="nav-item"><a href="#" class="nav-link">Status view</a></li><li class="nav-item"><a href="#" class="nav-link">View reports</a></li>' +
				$('.links').html()
			);
			createNav();
		});
