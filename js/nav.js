...
function createNav() {
  ...
  if (userdata.includes("admin") && userdata.includes("~")) {
    ...
    $(".featbadge").html(
      '<span class="badge badge-secondary"><i class="fas fa-edit"></i></span></span>'
    );
    ...
    $(".rep").html(
      '<a class="dropdown-item disabled" style="cursor:default;color:#6c757d"> Integrity coins: <span style="font-weight:bold;color:black">' +
        userdata[5] +
        "</span></a>"
    );
    ...
    if (userdata[4] == 1) {
      $(".featbadge").html(
        '<span class="badge badge-secondary"><i class="fas fa-code"></i></span></span>'
      );
    }
